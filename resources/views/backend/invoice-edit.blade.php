            ...
            <form action="{{ url('/admin/invoice-update/' . $invoice->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="serial_number" value="{{ $invoice->serial_number }}">
                    </div>
                    <div class="col-md-4 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="contact_number" value="{{ $invoice->contact_number }}">
                    </div>
                    <div class="col-md-4 mb-3">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="product_brand" value="{{ $invoice->product_brand }}">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">পণ্যের মডেল</label>
                        <input type="text" class="form-control" name="product_model" value="{{ $invoice->product_model }}">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">পণ্যের পরিমাণ</label>
                        <input type="number" class="form-control" name="product_quantity" value="{{ $invoice->product_quantity }}">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="product_category" value="{{ $invoice->product_category }}">
                    </div>
                    <div class="col-md-4 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control" name="product_received_date" value="{{ $invoice->product_received_date }}">
                    </div>
                </div>
